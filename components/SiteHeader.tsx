...
const serviceColumns = [
  {
    ...
    items: [
      ...
      { title: "Home Remodeling", copy: "Bathrooms, kitchens and whole-home renovations.", href: "/home-remodeling" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Custom Home Building", copy: "Ground-up homes managed from plan to walkthrough.", href: "/custom-home-building" },
