    ...
    <main className="about-page">
      ...
      <footer className="site-footer about-footer">
        <div className="footer-main">
          ...
          <div className="footer-column"><h3>Site</h3><a href="/">Home</a><a href="/services">Services</a><a href="/gallery">Portfolio</a><a href="/about">About</a><a href="#about-estimate">Contact</a></div>
