...
export default function NewHomeConstructionPage() {
  ...
  return (
    <main className="build-page">
      ...
      <footer className="site-footer build-footer">
        <div className="footer-main">
          ...
          <div className="footer-column"><h3>Site</h3><a href="/">Home</a><a href="/#services">Services</a><a href="/gallery">Portfolio</a><a href="/about">About</a><a href="#build-estimate">Contact</a></div>
          <div className="footer-column"><h3>New Homes</h3><a href="#build-scope">What We Manage</a><a href="#build-process">Building Process</a><a href="#build-estimate">Request a Conversation</a><a href="/residential-remodeling">Remodeling</a></div>
